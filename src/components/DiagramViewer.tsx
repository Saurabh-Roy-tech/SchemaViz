        ...
        <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                    <div className="space-y-3 flex-1">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-rose-50 text-rose-700 text-sm font-medium">
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-rose-50 text-rose-800 text-sm font-medium">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div className="p-6">
                        ...
                        <div className="space-y-4">
                            {loading ? (
                                <div className="flex items-center justify-center py-20">
                                    <svg className="animate-spin h-10 w-10 text-rose-600" fill="none" viewBox="0 0 24 24">
                    ...
                    {activeTab === 'dot' && (
                        <div className="overflow-auto max-h-[600px]">
                            <pre className="text-sm bg-gray-900 text-rose-300 p-6 rounded-xl overflow-x-auto font-mono">
                                {data.dotString}
                            </pre>
                        </div>
                    )}
